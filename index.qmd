...
- Explain RStudio projects/Repositories

:::

## 1st task - let's create our first repository


- Create a new repository on GitHub

- Create a new project in RStudio using version control

- Clone your GitHub repository and connect it to RStudio
...
-   You can manage your projects using different machines/collaborators
...
# That's it! The basic tool kit to start using git is ready
...
## Let's make small groups (maybe 4 people per group?)
...
- I hope you agree that git is a great tool
